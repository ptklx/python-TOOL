...
if platform.system().lower() == 'windows':
    ...
    image_path = '//SmartGo-Nas/pentao/data/sinet_extremenet/icome_task2_data/images'  #jpg
    mask_path = '//SmartGo-Nas/pentao/data/sinet_extremenet/icome_task2_data/profiles'   # jpg
    out_path = '//SmartGo-Nas/pentao/data/my_cleardata2/icome_task'
...
model_ENCODER =  'resnet101'  #'resnet50'


if winNolinux:
    model_path = '//SmartGo-Nas/pentao/code/4channels/Unet4/parameter/%s/best_model_21.pth'%model_ENCODER
else:
    model_path = '/mnt/pentao/code/4channels/Unet4/parameter/%s/best_model_21.pth'%model_ENCODER
    ...
    with torch.no_grad():
        if mattinghumanhaf:
            ...
            for index,ids in enumerate(img_ids):
                ...
                # mask= cv2.imread(os.path.join(mask_path,ids + ".jpg"), cv2.IMREAD_GRAYSCALE)[..., None]
