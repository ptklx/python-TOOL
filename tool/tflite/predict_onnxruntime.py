...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default=r"D:\algorithm\yolov5\tflite\yolov5n.onnx", help='Input your ONNX model.')

    parser.add_argument('--img', type=str, default=r"D:\algorithm\yolov5\tflite\assets\bus.jpg", help='Path to input image.')
