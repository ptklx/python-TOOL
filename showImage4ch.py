...
model_ENCODER =  'resnet34'  #'resnet50'

# model_path = '//SmartGo-Nas/pentao/code/4channels/Unet4/parameter/%s/best_model_last_0.pth'%model_ENCODER
model_path = '//SmartGo-Nas/pentao/code/4channels/Unet4/parameter/%s/best_model0.pth'%model_ENCODER
...
mean = np.array(mean)
std = np.array(std)
maskvalue = 0    #four channel value
zeroflag = 0      #
############
